...
def mask_iou_fast(mask_a, mask_b):
    ...
    tp = np.empty((mask_a.shape[0], mask_b.shape[0]), dtype=np.float32)
    fp = np.empty((mask_a.shape[0], mask_b.shape[0]), dtype=np.float32)
    fn = np.empty((mask_a.shape[0], mask_b.shape[0]), dtype=np.float32)
